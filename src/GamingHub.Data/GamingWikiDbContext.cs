namespace GamingWiki.Data
{
    ...
    public class GamingWikiDbContext : IdentityDbContext<IdentityUser>
    {
        public GamingWikiDbContext()
        {
        }

        public GamingWikiDbContext(DbContextOptions<GamingWikiDbContext> dbContextOptions)
